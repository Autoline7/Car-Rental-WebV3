            ...
            <div className="container">
                <div className="row models__row">
                    <div className="models__header">
                        ...
                        <select onChange={(event) => setSort(event.target.value)} defaultValue="" className="models__header__sort">
                            <option  disabled value="" className="models__header__sort__option">
                                Sort
                            </option>
                    ...
                    <div className="models__list">
                        ...
                        <Model setSelectedModel={setSelectedModel} setBookingOpen={setBookingOpen} key={model.id} model = {model}/>
